# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-16 14:42
...
class Migration(migrations.Migration):
    ...
    replaces = [(b'accounts', '0001_initial'), (b'accounts', '0002_document'), (b'accounts', '0003_remove_profile_otp'), (b'accounts', '0004_profile_otp'), (b'accounts', '0005_delete_document'), (b'accounts', '0006_document'), (b'accounts', '0007_delete_document'), (b'accounts', '0008_document'), (b'accounts', '0009_delete_document'), (b'accounts', '0010_document'), (b'accounts', '0011_delete_document'), (b'accounts', '0012_document'), (b'accounts', '0013_delete_document'), (b'accounts', '0014_document')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_verified', models.NullBooleanField(default=True)),
                ('mobile_verified', models.NullBooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xrp_destination_tag', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('btc_destination_tag', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
