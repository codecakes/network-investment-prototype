# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-19 17:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('login', 'login'), ('signup', 'signup'), ('mobile', 'mobile'), ('withdraw', 'withdraw'), ('buy', 'buy')], default=None, max_length=10, null=True)),
                ('status', models.CharField(blank=True, choices=[('active', 'active'), ('expire', 'expire')], default=None, max_length=10, null=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
